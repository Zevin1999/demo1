# Generated by Django 3.0.1 on 2020-01-07 00:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_rec', models.CharField(max_length=50)),
                ...
                ('order_status', models.IntegerField(choices=[(1, '待付款'), (2, '代发货'), (3, '代收货'), (4, '已完成')], default=1)),
            ],
        ),
        migrations.CreateModel(
            name='OrderGoods',
